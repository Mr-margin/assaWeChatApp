...
function jtcyxx() {
    ...
    var whcdval = wenhua_sz[whcd - 1] == undefined ? '未填写' : wenhua_sz[whcd - 1];
    var zxsqkval = zxszk_sz[zxs - 1] == undefined ? '未填写' : zxszk_sz[zxs - 1];
    var jkzkval= jkzk_sz[jkzk - 1] == undefined ? '未填写' : jkzk_sz[jkzk - 1];
    var ldjnval= ldjn_sz[ldjn - 1] == undefined ? '未填写' : ldjn_sz[ldjn - 1];
    var wgqkval= wgzk_sz[wgqk - 1] == undefined ? '未填写' : wgzk_sz[wgqk - 1];
    var qwgsjval= sj == undefined ? '未填写' : sj;
    var sfxyjrcval= xyjr_sz[junr] == undefined ? '未填写' : xyjr_sz[junr];
    var html = '<ul class="dorm-book mt3">' +
        ...
        '<span class="info-middle">' + whcdval + '</span> ' +
        '</li>' +
        '<li>' +
        '<span class="book-tit"><span class="heade-img" style="height:15px; width:15px;">' +
        ...
        ' <span class="info-middle">' + zxsqkval + '</span>  ' +
        '</li>' +
        '<li>' +
        '<span class="book-tit"><span class="heade-img" style="height:15px; width:15px;">' +
        ...
        ' <span class="info-middle">' + jkzkval + '</span>  ' +
        '</li>' +
        '<li>' +
        '<span class="book-tit"><span class="heade-img" style="height:15px; width:15px;">' +
        ...
        '<span class="info-middle">' + ldjnval + '</span>  ' +
        '</li>' +
    ...
    if (wgqk == 99) {
        ...
        html += '<span class="info-middle">' + wgqkval + '</span>  ';
    }
    html += '</li>' +
        '<li>' +
        '<span class="book-tit"><span class="heade-img" style="height:15px; width:15px;">' +
        ...
        '<span class="info-middle">' + qwgsjval + '</span>  ' +
        '</li>' +
        '  <li>' +
        '	<span class="book-tit"><span class="heade-img" style="height:15px; width:15px;">' +
        ...
        '    <span class="info-middle">' + sfxyjrcval + '</span>  ' +
        '</li>' +
        '</ul>';
    $("#jtcyxx").html(html);
}
