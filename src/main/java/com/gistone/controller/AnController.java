...
public class AnController{
	...
	/**
	 *根据帮夫人进行查询帮扶对象（公用）
	 * @author 太年轻   AND PERSONAL_NAME='"+name+"'去除名称过滤  20170410
	 * @date 2016年9月6日
	 * @param request
	 * @param response
	 * @throws IOException 
	...
	public void getSavePoorController (HttpServletRequest request,HttpServletResponse response) throws IOException{
		...
		String sql = "SELECT * FROM (SELECT AAB002,AAR008,BB.AAC001,BB.AAB001,CC.AAR100,CC.AAR010,AAB004,AAR012,AAQ002,AAC004,AAC005,AAC006,AAC007,AAC008,AAC012,NUM,V1,V3,V5,V7,V9,PIC_PATH FROM  " +
					"(SELECT HOUSEHOLD_NAME ,HOUSEHOLD_CARD FROM SYS_PERSONAL_HOUSEHOLD_MANY WHERE PERSONAL_PHONE ='"+phone+"'  GROUP BY HOUSEHOLD_NAME,HOUSEHOLD_CARD )AA "+
